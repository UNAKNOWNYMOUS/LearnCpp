...
- If you have done something that definitively violates the riles of the langugage, then your program is ill-formed.
...
- For gcc users: Add the following flags to your command line: `-Wall -Weffc++ -Wextra -Wconversion -Wsign-conversion`.
- For VS Code users:
## Treat warnings as errors
- Best practice: Enable "Treat warnings as errors". This will force you to resolve all issues causing warnings.
- For Visual Studio users:
- For Code::Blocks users:
- For gcc users: Add the following flag to your command line: `-Werror`.
- For VS Code users:
