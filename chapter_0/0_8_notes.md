...
- Q: When I compile my program, I get an error about unresolved symbol \_main\_ or \_WinMain@16.
...
- Q: When trying to use cin, cout, or end, the compiler says cin, cout, or end is an 'undeclared identifier'.
- Q: When trying to use endl to end a printed line, the compiler says end1 is an 'undeclared identifier'.
## Visual Studio issues
- Q: When compiling with Microsoft Visual C++, you get a C10010 fatal error, with an error message like "c:\vcprojects\test.cpp(263) :fatal error C1010: unexpected end of file while looking for precompiled header directive"
- Q: Visual Studio gives an error like: "1MSVCRTD.lib(exe_winmain.obj) : error LNK2022: unresolved external symbol _WinMain@16 referenced in function "int_cdecl invole_main(void)" (?invoke_main@@YAHXZ)"
